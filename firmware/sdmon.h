...
// PMD/TPK3 (PmdMon) para todo; esta ruta queda inactiva si no hay NNN.bin.
...
// Los nombres se conservan para no alterar la logica comun, pero en la 1.75C
// estas funciones montan/desmontan LittleFS en la NOR interna.
bool sdBegin();
void sdEnd();
