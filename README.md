...
원본의 거의 모든 부분을 수정하여 한글 UI, 다양한 미니게임, 기술 배틀,
수집·통신·산책과 휴대기기용 절전 기능을 더해 게임 전반을 확장했습니다.

### 먹이주기

- 세 가지 열매 중 좋아하는 열매를 먹으면 기분도 함께 좋아집니다.
- 배가 부르면 열매를 더 먹지 않지만 사탕은 먹을 수 있습니다.
- 사탕은 기분과 체력을 회복시키는 대신 몸무게를 늘립니다.

### 놀아주기

- **달리기:** 세 개의 레인을 이동하며 장애물을 피합니다.
- **깨우기:** 화면을 빠르게 터치해 점수를 쌓습니다.
- **과일 받기:** 캐릭터를 움직여 떨어지는 과일을 받습니다.
- **두더지 잡기:** 굴에서 올라오는 두더지를 찾아 터치합니다.
- **뛰어넘기:** 달려오는 장애물을 알맞은 순간에 뛰어넘습니다.
- **산책:** 만보계로 걸음 수를 기록하고 구간별 보상을 받습니다.

### 재우기와 시터

- **재우기:** 체력은 회복하지만 다른 능력치는 서서히 떨어지는 휴식 모드입니다.
- **시터:** 능력치가 떨어지거나 회복되지 않는 보호 모드이며 오후 7시까지만
  유지됩니다.

### 성장·배틀·수집

- 함께 지낸 시간에 따라 성장하고 조건을 만족하면 진화하거나 작별할 수
  있습니다.
- 야생 상대와 기술·회복·도망을 선택해 배틀하고, 승리하면 포획을 시도할 수
  있습니다.
- 만난 상대와 특별한 색의 개체를 도감에 모으고, 기술 디스크로 보유 기술을
  바꿀 수 있습니다.

### 통신과 휴대 기능

- 두 기기를 가까이 두고 통신 배틀과 짝짓기를 진행할 수 있습니다.
- 화면 자동 끄기, 절전 상태, 케어 호출, 시간 보정과 저장 데이터 복구 기능을
  갖춰 휴대용 육성 게임으로 사용할 수 있습니다.
